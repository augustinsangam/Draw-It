 ...
 * @returns Draws
 */
static getSizePrefixedRoot(bb:flatbuffers.ByteBuffer, obj?:Draws):Draws {
 ...
 * @returns DrawBuffer
 */
static getSizePrefixedRoot(bb:flatbuffers.ByteBuffer, obj?:DrawBuffer):DrawBuffer {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new DrawBuffer()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns Draw
 */
static getSizePrefixedRoot(bb:flatbuffers.ByteBuffer, obj?:Draw):Draw {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Draw()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static addColors(builder:flatbuffers.Builder, colorsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, colorsOffset, 0);
};
...
static addSvg(builder:flatbuffers.Builder, svgOffset:flatbuffers.Offset) {
  builder.addFieldOffset(4, svgOffset, 0);
};
...
static addWidth(builder:flatbuffers.Builder, width:number) {
  builder.addFieldInt16(6, width, 0);
};
...
static create(builder:flatbuffers.Builder, colorOffset:flatbuffers.Offset, colorsOffset:flatbuffers.Offset, height:number, nameOffset:flatbuffers.Offset, svgOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, width:number):flatbuffers.Offset {
  Draw.start(builder);
  Draw.addColor(builder, colorOffset);
  Draw.addColors(builder, colorsOffset);
  Draw.addHeight(builder, height);
  Draw.addName(builder, nameOffset);
  Draw.addSvg(builder, svgOffset);
  Draw.addTags(builder, tagsOffset);
  Draw.addWidth(builder, width);
 ...
 * @returns Element
 */
static getSizePrefixedRoot(bb:flatbuffers.ByteBuffer, obj?:Element):Element {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Element()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns Node
 */
childrenType(index: number):Node|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? /**  */ (this.bb!.readUint8(this.bb!.__vector(this.bb_pos + offset) + index)) : /**  */ (0);
};
 ...
 * @returns Uint8Array
 */
childrenTypeArray():Uint8Array|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? new Uint8Array(this.bb!.bytes().buffer, this.bb!.bytes().byteOffset + this.bb!.__vector(this.bb_pos + offset), this.bb!.__vector_len(this.bb_pos + offset)) : null;
};
 ...
 */
children<T extends flatbuffers.Table>(index: number, obj:T):T|null {
  var offset = this.bb!.__offset(this.bb_pos, 10);
...
/**
 * @param flatbuffers.Builder builder
 * @param flatbuffers.Offset childrenTypeOffset
 */
static addChildrenType(builder:flatbuffers.Builder, childrenTypeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(2, childrenTypeOffset, 0);
};
 ...
 * @returns flatbuffers.Offset
 */
static createChildrenTypeVector(builder:flatbuffers.Builder, data:Node[]):flatbuffers.Offset {
  builder.startVector(1, data.length, 1);
  for (var i = data.length - 1; i >= 0; i--) {
    builder.addInt8(data[i]);
  }
 ...
 * @param number numElems
 */
static startChildrenTypeVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(1, numElems, 1);
};
...
static create(builder:flatbuffers.Builder, nameOffset:flatbuffers.Offset, attrsOffset:flatbuffers.Offset, childrenTypeOffset:flatbuffers.Offset, childrenOffset:flatbuffers.Offset):flatbuffers.Offset {
  Element.start(builder);
  Element.addName(builder, nameOffset);
  Element.addAttrs(builder, attrsOffset);
  Element.addChildrenType(builder, childrenTypeOffset);
 ...
 * @returns Text
 */
static getRoot(bb:flatbuffers.ByteBuffer, obj?:Text):Text {
 ...
 * @returns Text
 */
static getSizePrefixedRoot(bb:flatbuffers.ByteBuffer, obj?:Text):Text {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Text()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
...
static create(builder:flatbuffers.Builder, contentOffset:flatbuffers.Offset):flatbuffers.Offset {
  Text.start(builder);
  Text.addContent(builder, contentOffset);
  return Text.end(builder);
}
}
/**
 * @constructor
 ...
 * @returns Attr
 */
static getSizePrefixedRoot(bb:flatbuffers.ByteBuffer, obj?:Attr):Attr {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Attr()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
