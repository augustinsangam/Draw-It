...
<img class="doc-fig" src="../../assets/doc/imgs/doc-outilCrayon.png" title="Exemple de motif réalisé à l'aide de l'outil Crayon" alt="image outil crayon" width="100%">
...
<video width="70%" height="70%" class="doc-fig" autoplay loop>
    <source src="../../assets/sidebar-icons/crayon_trctd.webm" type="video/webm">
</video>
