...
L’outil couleur peut être accédé en cliquant sur l’icône ![Icône palette de couleurs](/assets/icons/color-palette.png). Pour choisir une couleur, cliquez dans la palette prévue à cet effet. Vous pouvez ajuster la transparence de la couleur en indiquant une valeur en pourcentages dans le champ `A`.
